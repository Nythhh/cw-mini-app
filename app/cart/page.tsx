  ...
  if (items.length === 0) {
    return (
      <div className="space-y-5 pt-4">
        <SectionTitle title="Panier 🛒" subtitle="Tes produits sélectionnés apparaissent ici." />
        <EmptyState icon={ShoppingBag} title="Panier vide" description="Ajoute des produits depuis le catalogue pour commencer ta commande." />
